...
var R = (t, i, e) =>
    i in t
      ? X(t, i, { enumerable: !0, configurable: !0, writable: !0, value: e })
      : (t[i] = e),
  O = (t, i) => {
    for (var e in i || (i = {})) Y.call(i, e) && R(t, e, i[e]);
    if (H) for (var e of H(i)) A.call(i, e) && R(t, e, i[e]);
    return t;
  };
var o = (t, i, e) => R(t, typeof i != "symbol" ? i + "" : i, e);
var D = "1.3.17";
function k(t, i, e) {
...
var U = class {
  ...
  advance(t) {
    ...
    if (this.duration && this.easing) {
      this.currentTime += t;
      const l = k(0, this.currentTime / this.duration, 1);
      i = l >= 1;
      const s = i ? 1 : this.easing(l);
      this.value = this.from + (this.to - this.from) * s;
    } else
      this.lerp
        ? ((this.value = V(this.value, this.to, this.lerp * 60, t)),
  ...
  fromTo(t, i, { lerp: e, duration: l, easing: s, onStart: n, onUpdate: h }) {
...
function q(t, i) {
  ...
  return function (...l) {
    ...
    clearTimeout(e),
      (e = setTimeout(() => {
        (e = void 0), t.apply(s, l);
      }, i));
  };
}
var C = class {
    constructor(t, i, { autoResize: e = !0, debounce: l = 250 } = {}) {
      o(this, "width", 0);
      o(this, "height", 0);
      ...
      (this.wrapper = t),
        (this.content = i),
        e &&
          ((this.debouncedResize = q(this.resize, l)),
          this.wrapper instanceof Window
  ...
  M = class {
    ...
    emit(t, ...i) {
      ...
      for (let s = 0, n = e.length; s < n; s++)
        (l = e[s]) == null || l.call(e, ...i);
    }
    on(t, i) {
      var e;
      return (
        ((e = this.events[t]) != null && e.push(i)) || (this.events[t] = [i]),
        () => {
          var l;
          this.events[t] =
            (l = this.events[t]) == null ? void 0 : l.filter((s) => i !== s);
        }
      );
    }
    off(t, i) {
      var e;
      this.events[t] =
        (e = this.events[t]) == null ? void 0 : e.filter((l) => i !== l);
    }
    destroy() {
      this.events = {};
    }
  ...
  F = class {
    constructor(t, i = { wheelMultiplier: 1, touchMultiplier: 1 }) {
      o(this, "touchStart", { x: 0, y: 0 });
      o(this, "lastDelta", { x: 0, y: 0 });
      o(this, "window", { width: 0, height: 0 });
      o(this, "emitter", new M());
      ...
      o(this, "onTouchMove", (t) => {
        const { clientX: i, clientY: e } = t.targetTouches
            ? t.targetTouches[0]
            : t,
          l = -(i - this.touchStart.x) * this.options.touchMultiplier,
          s = -(e - this.touchStart.y) * this.options.touchMultiplier;
        (this.touchStart.x = i),
          (this.touchStart.y = e),
          (this.lastDelta = { x: l, y: s }),
          this.emitter.emit("scroll", { deltaX: l, deltaY: s, event: t });
      });
      o(this, "onTouchEnd", (t) => {
      ...
      o(this, "onWheel", (t) => {
        let { deltaX: i, deltaY: e, deltaMode: l } = t;
        const s = l === 1 ? x : l === 2 ? this.window.width : 1,
          n = l === 1 ? x : l === 2 ? this.window.height : 1;
        (i *= s),
          (e *= n),
  ...
  _ = (t) => Math.min(1, 1.001 - Math.pow(2, -10 * t)),
  B = class {
    constructor({
      wrapper: t = window,
      ...
      gestureOrientation: r = v === "horizontal" ? "both" : "vertical",
      touchMultiplier: f = 1,
      wheelMultiplier: m = 1,
      autoResize: S = !0,
      prevent: u,
      ...
      naiveDimensions: b = T,
      stopInertiaOnNavigate: N = !1,
    } = {}) {
      o(this, "_isScrolling", !1);
      o(this, "_isStopped", !1);
      o(this, "_isLocked", !1);
      o(this, "_preventNextNativeScrollEvent", !1);
      ...
      o(this, "options");
      o(this, "targetScroll");
      o(this, "animatedScroll");
      o(this, "animate", new U());
      o(this, "emitter", new M());
      o(this, "dimensions");
      o(this, "virtualScroll");
      o(this, "onScrollEnd", (t) => {
      ...
      o(this, "onClick", (t) => {
        const e = t
          .composedPath()
          .filter(
            (l) => l instanceof HTMLAnchorElement && l.getAttribute("href")
          );
        if (this.options.anchors) {
          const l = e.find((s) => {
            var n;
            return (n = s.getAttribute("href")) == null
              ? void 0
              : n.includes("#");
          });
          if (l) {
        ...
        this.options.stopInertiaOnNavigate &&
          e.find((s) => s.host === window.location.host) &&
          this.reset();
      });
      ...
      o(this, "onVirtualScroll", (t) => {
        if (
          ...
          return;
        const { deltaX: i, deltaY: e, event: l } = t;
        if (
          ...
          l.ctrlKey || l.lenisStopPropagation)
        )
          return;
        const s = l.type.includes("touch"),
          n = l.type.includes("wheel");
        this.isTouching = l.type === "touchstart" || l.type === "touchmove";
        const h = i === 0 && e === 0;
        if (
        ...
        const a =
          ...
          (this.options.gestureOrientation === "horizontal" && i === 0);
        if (h || a) return;
        let c = l.composedPath();
        ...
        if (
          c.find((u) => {
            ...
            return (
              ...
              ((typeof d == "function" && (d == null ? void 0 : d(u))) ||
                ((w = u.hasAttribute) == null
                  ? void 0
                  : w.call(u, "data-lenis-prevent")) ||
                (s &&
                  ((g = u.hasAttribute) == null
                    ? void 0
                    : g.call(u, "data-lenis-prevent-touch"))) ||
                (n &&
                  ((y = u.hasAttribute) == null
                    ? void 0
                    : y.call(u, "data-lenis-prevent-wheel"))) ||
                (this.options.allowNestedScroll &&
                  this.checkNestedScroll(u, { deltaX: i, deltaY: e })))
            );
          })
        )
          return;
        ...
        if (
          !((this.options.syncTouch && s) || (this.options.smoothWheel && n))
        ) {
          (this.isScrolling = "native"),
            this.animate.stop(),
            (l.lenisStopPropagation = !0);
          return;
        }
        let r = e;
        this.options.gestureOrientation === "both"
          ? (r = Math.abs(e) > Math.abs(i) ? e : i)
          : this.options.gestureOrientation === "horizontal" && (r = i),
          (!this.options.overscroll ||
            ...
            (l.lenisStopPropagation = !0),
          l.cancelable && l.preventDefault();
        const f = s && this.options.syncTouch,
          S = s && l.type === "touchend";
        S &&
          (r =
      ...
      (window.lenisVersion = D),
        (!t || t === document.documentElement) && (t = window),
        typeof p == "number" && typeof a != "function"
          ? (a = _)
          : typeof a == "function" && typeof p != "number" && (p = 1),
        (this.options = {
          wrapper: t,
          content: i,
          eventsTarget: e,
        ...
        (this.dimensions = new C(t, i, { autoResize: S })),
    ...
    scrollTo(
      t,
      {
        ...
        lock: l = !1,
        programmatic: s = !0,
        lerp: n = s ? this.options.lerp : void 0,
        duration: h = s ? this.options.duration : void 0,
        easing: p = s ? this.options.easing : void 0,
        onStart: a,
        onComplete: c,
        force: d = !1,
        userData: v,
        ...
        if (typeof t == "string" && ["top", "left", "start", "#"].includes(t))
          ...
          if (
            (typeof t == "string"
              ...
              : t instanceof HTMLElement && t != null && t.nodeType && (r = t),
            r)
          ) {
        ...
        if (typeof t == "number") {
          if (((t += i), (t = Math.round(t)), this.options.infinite)) {
            if (s) {
              ...
              r > this.limit / 2
                ? (t = t - this.limit)
                : r < -this.limit / 2 && (t = t + this.limit);
            }
          } else t = k(0, t, this.limit);
          if (t === this.targetScroll) {
            a == null || a(this), c == null || c(this);
            return;
          }
          if (((this.userData = v != null ? v : {}), e)) {
    ...
    checkNestedScroll(t, { deltaX: i, deltaY: e }) {
      var z, L;
      const l = Date.now(),
        s = (z = t._lenis) != null ? z : (t._lenis = {});
      let n, h, p, a, c, d, v, r;
      const f = this.options.gestureOrientation;
      if (l - ((L = s.time) != null ? L : 0) > 2e3) {
        s.time = Date.now();
        ...
        const b = T.overflowX,
          N = T.overflowY;
        if (
          ((n = ["auto", "overlay", "scroll"].includes(b)),
          (h = ["auto", "overlay", "scroll"].includes(N)),
          (s.hasOverflowX = n),
          (s.hasOverflowY = h),
          (!n && !h) || (f === "vertical" && !h) || (f === "horizontal" && !n))
        )
          return !1;
        (c = t.scrollWidth),
          (d = t.scrollHeight),
      ...
      if (!m) return !1;
      let S, u, w, g, y;
      if (m === "x") (S = t.scrollLeft), (u = c - v), (w = i), (g = n), (y = p);
      else if (m === "y")
        (S = t.scrollTop), (u = d - r), (w = e), (g = h), (y = a);
      else return !1;
      return (w > 0 ? S < u : S > 0) && g && y;
    }
    get rootElement() {
